...
use RESTBundle\Form\OnlineOutgoerPreparationParticipationType;
 ...
 */
class OnlineOutgoerPreparationParticipationController extends RESTBundleController
{
     ...
     *  output={"class"="RESTBundle\Form\OnlineOutgoerPreparationParticipationType", "collection"=true}
     * )
     */
    public function cgetAction(ParamFetcherInterface $paramFetcher)
    {
        ...
        $qb->select('o')->from('AIESECGermany\EntityBundle\Entity\OnlineOutgoerPreparationParticipation', 'o');
        if ($personID) {
    ...
    public function getAction(ParamFetcherInterface $paramFetcher, $participationID)
    {
        $this->checkAuthentication($paramFetcher);
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('AIESECGermany\EntityBundle\Entity\OnlineOutgoerPreparationParticipation')->findOneById($participationID);
        if ($entity) {
            return $entity;
        } else {
