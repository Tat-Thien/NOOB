 ...
 */
class ReportsController extends NoobBundleController
{
	 ...
	 * @REST\QueryParam(name="access_token", allowBlank=false)
	 * @REST\QueryParam(map=true, name="ids", requirements="\d+", allowBlank=false, description="IDs of persons for which to display the data.")
	 * @ApiDoc(
